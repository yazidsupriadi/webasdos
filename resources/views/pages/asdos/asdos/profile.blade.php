  ...
  <!-- Page Heading -->
          ...
          <div class="row">
            <div class="card-body text-gray-800">
                ...
                <div class="col-1g-6">
                <div class="card">
                    <h5 class="card-header">Asdos Profile</h5>
