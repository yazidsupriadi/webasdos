          ...
          <div class="row">
            ...
            <div class="card-body text-gray-800">
                ...
                @foreach(Auth::user()->matkul as $matkul)
                             <li class="text-bold " style="list-style:none;font-size:16px">  {{$matkul->nama}}</li>   
                 @endforeach
                ...
                <div class="card">
                    ...
                    <div class="card-body p-3">
                        @foreach($asdos as $item)
                            ...
                            <a href="{{url('asdos/profile/edit',Auth::user()->id)}}">Edit Profile</a>
                         @endforeach
