...
@include('sweetalert::alert')
  ...
  <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Daftar Asdos Mata Kuliah Aktif</h1>
          </div>
          ...
          <a href="/admin/daftar-asistensi-tidak-aktif" class="btn btn-warning btn-sm my-3 mx-3">Asistensi Tidak Aktif</a>
          <!-- Content Row -->
          <div class="row">
