                  ...
                  <div class="col-md-4 d-flex justify-content-center" data-aos="fade-right" data-aos-duration="1000">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <p class="card-text" style="font-size:14px">" Dengan menjadi asisten dosen di STT Terpadu Nurul FIkri asisten dosen juga akan mendapatkan insentif setiap bulanya"</p>
                  ...
                  <div class="col-md-4 d-flex justify-content-center ">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body" data-aos="fade-right" data-aos-duration="1500">
                            ...
                            <h5 class="card-title">Sertifikat Mengajar</h5>
                            <p class="card-text" style="font-size:14px">" Dengan menjadi asisten dosen kamu akan mendapatkan sertifikat lisensi sebagai asisten dosen di STT Terpadu Nurul Fikri "</p>
            ...
            <div class="row align-items-center">
                <div class="col">
                    <div class="card mb-3" style="width: 15rem;" data-aos="fade-up" data-aos-duration="1000">
                        <img class="card-img-top" src="{{Storage::url($item->foto)}}" alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title" style="font-size:16px; font-weight:bold;">{{$item->nama_asdos}}</h5>
                          <p class="card-text" style="color:#999aa4; font-size:14px;" >{{$item->matkul}} <br> {{$item->tahun_akademik}}</p>
                          <p class="card-text" style="font-size:14px">{{$item->testimoni}}</p>
